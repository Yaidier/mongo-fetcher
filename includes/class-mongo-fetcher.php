 ...
 * @subpackage Mongo_Fetcher/includes
 */
...
class Mongo_Fetcher {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Mongo_Fetcher_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      string    $mongo_fetcher    The string used to uniquely identify this plugin.
	 */
	protected $mongo_fetcher;
	...
	public function __construct() {
		...
		$this->mongo_fetcher = 'mongo-fetcher';
	 ...
	 *
	 * - Mongo_Fetcher_Loader. Orchestrates the hooks of the plugin.
	 * - Mongo_Fetcher_i18n. Defines internationalization functionality.
	 * - Mongo_Fetcher_Admin. Defines all hooks for the admin area.
	 * - Mongo_Fetcher_Public. Defines all hooks for the public side of the site.
	 *
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-mongo-fetcher-loader.php';
	 ...
	 *
	 * Uses the Mongo_Fetcher_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	 ...
	 */
	public function get_mongo_fetcher() {
		return $this->mongo_fetcher;
	}
	 ...
	 *
	 * @since     1.0.0
	 * @return    Mongo_Fetcher_Loader    Orchestrates the hooks of the plugin.
	 */
